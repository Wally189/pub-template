(function () {
  ...
  var storageKey = "waylight-template-theme-pub";
  ...
  var initialTheme = normalizeTheme(root.getAttribute("data-theme") || "orange");
  try {
    initialTheme = window.localStorage.getItem(storageKey) || initialTheme;
  } catch (error) {
    initialTheme = normalizeTheme(root.getAttribute("data-theme") || "orange");
  }
